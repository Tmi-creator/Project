...
def interface():
    ...
    if (choice1 == 1):
        ...
        if (choice2 == 1):
            ...
            units = {
                1: [Warrior, UnitsInfo(hp=200, atk=20, mana=50, first_skill=-10, second_skill=40, third_skill=15),
                    Warrior.attack, Warrior.simple_skill, Warrior.kill_rogue]
                2: [Mage, UnitsInfo(hp=100, atk=40, mana=100, first_skill=2048, second_skill=10, third_skill=15),
                    Mage.total_annigilation, Mage.buff, Mage.mana_up],
                3: [Rogue, UnitsInfo(hp=50, atk=60, mana=50, first_skill=75, second_skill=50, third_skill=10)],
                4: [Paladin, UnitsInfo(hp=150, atk=15, mana=75, first_skill=-5, second_skill=40, third_skill=10),
                    Paladin.attack, Paladin.heal, Paladin.help_of_god],
                ...
                9: [Priest, UnitsInfo(hp=150, atk=20, mana=50, first_skill=80, second_skill=5, third_skill=5),
                    Priest.heal,
